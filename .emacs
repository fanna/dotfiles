...
(defun casey-big-fun-c-hook ()
  ...
  (defun casey-header-format ()
     ...
     (insert "   $Date: $\n")
     (insert "   $Revision: $\n")
     (insert "   $Creator: Stefan Mijucic $\n")
     (insert "   $Notice: (C) Copyright 2014 by Stefan Mijucic , Inc. All Rights Reserved. $\n")
     (insert "   ======================================================================== */\n")
     (insert "\n")
     (insert "#define ")
     (push-mark)
...
(custom-set-variables
 ...
 '(auto-save-timeout 0)
 '(auto-show-mode t t)
 '(custom-safe-themes (quote ("42ccd5eadda3546a89026b94794df7f4addadf25417b96917cf9db2f892b25a4" default)))
